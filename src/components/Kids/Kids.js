        ...
        return (
            ...
            <div className="card h-100 mb-4" style={{ width: '18rem' }} key={item.id}>
                ...
                <div className="card-body">
                    ...
                    <h5 className="card-title mb-1">Rs-{item.price}</h5>
                    <NavLink to={`/kids/${item.id}`} className="btn btn-primary">Buy Now</NavLink>
                </div>
            </div>
        )
    }
